...
import 'package:titipin_app/screens/auth/welcome_screen.dart';
...
import 'package:titipin_app/screens/deliverer/deliverer_onboarding_screen.dart';
    ...
    try {
      ...
      try {
        ...
        final verificationStatus =
            verificationData['status']?.toString().toUpperCase() ?? '';
        final currentStep = verificationData['currentStep']?.toString() ?? '';
        ...
        switch (currentStep) {
          case 'registration':
            ...
            final hasOnboarded =
                await _storage.read(key: 'deliverer_onboarded');
        ...
        // If verification check fails, show onboarding
        return AuthResult(status: AuthStatus.needsOnboarding);
      }
    } catch (e) {
