...
import 'package:tugasakhir/features/deliverer/screens/available_orders_screen.dart';
import 'package:tugasakhir/features/deliverer/screens/active_orders_screen.dart';
import 'package:tugasakhir/features/chat/screens/deliverer_chat_list_screen.dart';
import 'package:tugasakhir/features/deliverer/screens/deliverer_profile_screen.dart';
...
class _DelivererMainScreenState extends State<DelivererMainScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 3. BottomNavigationBar (Kode ini sudah benar, tidak perlu diubah)
